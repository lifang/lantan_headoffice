...
function new_store_validate(obj){   //新建门店验证
        ...
        if($.trim($("#new_store_name").val()) == null || $.trim($("#new_store_name").val()) == ""){
            tishi_alert("请输入门店名称");
            flag = false;
        };
        if($.trim($("#new_store_contact").val()) == null || $.trim($("#new_store_contact").val()) == ""){
            tishi_alert("请输入负责人姓名");
            flag = false;
        };
        if($.trim($("#new_store_phone").val()) == null || $.trim($("#new_store_phone").val()) == ""){
            tishi_alert("至少有个联系电话");
            flag = false;
        };
        if($.trim($("#new_store_address").val()) == null || $.trim($("#new_store_address").val()) == ""){
            tishi_alert("请输入门店地址");
            flag = false;
        };
        ...
        if($.trim($("#new_store_location_x").val()) == null || $.trim($("#new_store_location_x").val()) == "" || $("#new_store_location_y").val() == null || $("#new_store_location_y").val() == ""){
            tishi_alert("请输入正确的门店坐标");
            flag = false;
        };
