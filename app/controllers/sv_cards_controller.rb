  ...
  def create          #创建优惠卡
    ...
    if card_type == 1                                       #如果是储值卡
      ...
      if sv_card.save      
        ...
        thumbnail = MiniMagick::Image.open("public/cardimg/#{img_name}").resize("148*93")
        thumbnail.write "public/cardimg/mini_#{img_name}"
      end
      ...
      if sv_card.save     
        ...
        product_id.each_with_index do |item,index|  #前面是对象，后面是索引
